...
function Sigmate() {
  ...
  return new _keystore2.default(_extends({}, opts, { web3: web3 })).then(function (res) {
    ...
    var passedContracts = opts.contracts || opts.deployer && opts.deployer.known_contracts;
    ...
    return { web3: newWeb3, keystore: keystore, accounts: accounts, contracts: contracts, deployer: deployer };
  });
}